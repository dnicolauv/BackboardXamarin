...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("com.tumblr.backboard.MotionImitator, BackboardLib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MotionImitator.class, __md_methods);
	}


	public MotionImitator () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MotionImitator.class)
			mono.android.TypeManager.Activate ("com.tumblr.backboard.MotionImitator, BackboardLib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public MotionImitator (double p0, int p1, int p2) throws java.lang.Throwable
	{
		super ();
		if (getClass () == MotionImitator.class)
			mono.android.TypeManager.Activate ("com.tumblr.backboard.MotionImitator, BackboardLib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "System.Double, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e:System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e:System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0, p1, p2 });
	}

	public MotionImitator (com.facebook.rebound.Spring p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == MotionImitator.class)
			mono.android.TypeManager.Activate ("com.tumblr.backboard.MotionImitator, BackboardLib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Com.Facebook.Rebound.Spring, ReboundDroid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}

	public MotionImitator (com.facebook.rebound.Spring p0, int p1, int p2) throws java.lang.Throwable
	{
		super ();
		if (getClass () == MotionImitator.class)
	...
	public MotionImitator (com.facebook.rebound.Spring p0, double p1, int p2, int p3) throws java.lang.Throwable
	{
		super ();
		if (getClass () == MotionImitator.class)
