...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("com.tumblr.backboard.SpringImitator, BackboardLib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SpringImitator.class, __md_methods);
	}


	public SpringImitator () throws java.lang.Throwable
	{
		super ();
		if (getClass () == SpringImitator.class)
			mono.android.TypeManager.Activate ("com.tumblr.backboard.SpringImitator, BackboardLib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public SpringImitator (double p0, int p1, int p2) throws java.lang.Throwable
	{
		super ();
		if (getClass () == SpringImitator.class)
			mono.android.TypeManager.Activate ("com.tumblr.backboard.SpringImitator, BackboardLib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "System.Double, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e:System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e:System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0, p1, p2 });
	}

	public SpringImitator (com.facebook.rebound.Spring p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == SpringImitator.class)
			mono.android.TypeManager.Activate ("com.tumblr.backboard.SpringImitator, BackboardLib, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Com.Facebook.Rebound.Spring, ReboundDroid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}

	public SpringImitator (com.facebook.rebound.Spring p0, int p1, int p2) throws java.lang.Throwable
	{
		super ();
		if (getClass () == SpringImitator.class)
	...
	public SpringImitator (com.facebook.rebound.Spring p0, double p1, int p2, int p3) throws java.lang.Throwable
	{
		super ();
		if (getClass () == SpringImitator.class)
